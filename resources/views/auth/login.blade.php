...
<html lang="en">
	...
	<head><base href="../../../../">
		...
		<!--end::Layout Themes-->
		{{-- <link rel="shortcut icon" href="{{asset('assets/media/logos/E-commerce.png')}}" /> --}}
	</head>
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
				...
				<div class="login-aside d-flex flex-row-auto bgi-size-cover bgi-no-repeat p-10 p-lg-10" style="background-image: url({{asset('assets/media/bg/bg-4.jpg')}});">
					...
					<div class="d-flex flex-row-fluid flex-column justify-content-between">
						...
						<a href="#" class="flex-column-auto mt-5 pb-lg-0 pb-10">
							{{-- <img src="{{asset('assets/media/logos/E-commerce2.png')}}" class="max-h-100px" alt="" /> --}}
						</a>
						<!--end: Aside header-->
						<!--begin: Aside content-->
						<div class="flex-column-fluid d-flex flex-column justify-content-center">
							<h3 class="font-size-h1 mb-5 text-white">Welcome to E-commerce !</h3>
							<p class="font-weight-lighter text-white opacity-80">REAL ESTATE DEVELOPMENT </p>
						</div>
						<!--end: Aside content-->
						<!--begin: Aside footer for desktop-->
						<div class="d-none flex-column-auto d-lg-flex justify-content-between mt-10">
							<div class="opacity-70 font-weight-bold text-white">© 2021 E-commerce</div>
				...
				<div class="d-flex flex-column flex-row-fluid position-relative p-7 overflow-hidden">
					...
					<div class="d-flex flex-column-fluid flex-center mt-30 mt-lg-0">
						...
						<div class="login-form login-signin">
							...
							<!--begin::Form-->
							<form action="{{route('login')}}" class="form" novalidate="novalidate" id=" login"  >
                                @csrf
								<div class="form-group">
									<input class="form-control form-control-solid h-auto py-5 px-6" type="email" name="email" id="email" placeholder="Email"  />
								</div>
								<div class="form-group">
									<input class="form-control form-control-solid h-auto py-5 px-6" type="password" placeholder="Password" id="password" name="password"  />
								</div>
								<!--begin::Action-->
								<div class="form-group d-flex flex-wrap justify-content-between align-items-center">
									<a href="javascript:;" class="text-dark-50 text-hover-primary my-3 mr-2" id="kt_login_forgot">Forgot Password ?</a>
									<button type="button" id="btn-submit" class="btn btn-primary font-weight-bold px-9 py-4 my-3">Sign In</button>
								</div>
								<!--end::Action-->
							</form>
							<!--end::Form-->
						...
						<div class="login-form login-forgot">
							...
							<!--begin::Form-->
							<form class="form" novalidate="novalidate" action="{{ route('password.email') }}" method="POST" id="kt_login_forgot_form">
								@csrf
								<div class="form-group">
									<input class="form-control form-control-solid h-auto py-5 px-6" type="email" placeholder="Email" name="email" autocomplete="off" />
								</div>
					...
					<div class="d-flex d-lg-none flex-column-auto flex-column flex-sm-row justify-content-between align-items-center mt-5 p-5">
						<div class="text-dark-50 font-weight-bold order-2 order-sm-1 my-2">© 2022 METRICAL</div>
		...
		<script src="{{asset('core/scripts.bundle.js')}}"></script>
		<!--end::Global Theme Bundle-->
		<!--begin::Page Scripts(used by this page)-->
		{{-- <script src="{{asset('core/pages/custom/login/login-general.js')}}"></script> --}}
        <script src="{{ asset('/core/http.js') }}"></script>
		<script src="{{ asset('/core/login.js') }}"></script>
