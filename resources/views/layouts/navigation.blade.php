    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item  @if(isset($data['activePage']['users'])) menu-item-active   @endif" aria-haspopup="true">
                    <a href="{{route('users.manage')}}" class="menu-link">
                        ...
                        <span class="menu-text dashbord" >Users</span>
                    </a>
                </li>
                <li class="menu-item  @if(isset($data['activePage']['products'])) menu-item-active   @endif" aria-haspopup="true">
                    <a href="{{route('products.manage')}}" class="menu-link">
                        ...
                        <span class="menu-text dashbord" >products</span>
                    </a>
                </li>
                <li class="menu-item  @if(isset($data['activePage']['orders'])) menu-item-active   @endif" aria-haspopup="true">
                    <a href="{{route('orders.manage')}}" class="menu-link">
                        ...
                        <span class="menu-text dashbord" >orders</span>
                    </a>
                </li>
            </ul>
            <!--end::Menu Nav-->
